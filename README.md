...
- **Impact**: Reduced average resolution time by 35%, improved team efficiency  

### 🍽️ Café & Restaurant Management System  
University project implementing comprehensive management system with visual reporting  
- **Tech**: Database Management, System Design, SQL  
- **Features**: Order management, inventory tracking, sales reporting  
...
World Economic Forum • Engineers Australia • Honor Society • ABC Hub • Life Expert LLC • IEA Xchange
...
- 📚 Advancing knowledge in **cloud infrastructure** (AWS, Azure)  
